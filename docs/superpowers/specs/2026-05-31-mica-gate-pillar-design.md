...
- **Arm retraction slot:** 20 × 120 mm rectangle at (Y=120, Z=150). Spans Y 110–130 × Z 90–210. Drop-arm (115mm) sweeps through the panel from θ=0° (closed horizontal) to θ≈71° (slot top Z=210 clips the arm cross-section upper edge). At θ=71° arm tip lands at (X=157, Z=209) — opens visibly but sits lower than the trụ top, leaving ~90mm of solid panel above the slot. Slot bottom has 42mm clearance above the HC-SR04 PCB.
...
### 5.8 Drop-arm (115 × 15 × 3)

- **Mounting holes:** 2× Ø2.2mm at distance 5mm and 13mm from one short end (8mm spacing matches SG90 1-arm horn).
- **Decoration:** 3 engraved stripes 20×5mm at X = 35, 65, 95 (paint red after cutting for red/white barrier look). Stripes clear the 2 mount holes at X=5/13 by 12mm and stay inside the 115mm arm length (10mm margin from arm tip).
...
| Drop-arm pivot | SG90 servo horn outside the servo body | 2× M2 screws through arm into horn arm | Pivot at trụ (X=120, Y=120, Z=100). Arm **115mm** × 15mm × 3mm (= slot height 120 − 5mm clearance). Closed: arm horizontal +X, tip at (X=235, Z=100). Open at θ≈71° (slot top Z=210 clips arm cross-section): tip at (X=157, Z=209) — open position sits ~80mm lower than previous 195mm-arm design. |
...
- Row 2: TOP (150×168) + SLOPE (150×101.8) + BOTTOM (150×240) + ARM (115×15) — width 597, height 240
...
8. **Q8 RESOLVED: Arm 115mm (= slot height 120 − 5mm) sweeps from horizontal to ~71°; tip at (X=157, Z=209) at max angle — opens visibly but stays in the lower-middle of the panel, ~90mm below trụ top.**
...
| Servo can't lift drop-arm (115mm × 15mm × 3mm acrylic) under its own weight | Low | SG90 stall torque ~1.8 kg·cm; 115mm × 15mm × 3mm acrylic ≈ 5g, moment arm ~57mm → torque ~0.028 kg·cm — well within SG90's 1.8 kg·cm rating |
